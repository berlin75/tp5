<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:67:"E:\wamp64\www\tp5/application/admin\view\authrule\authrulelist.html";i:1502960381;s:57:"E:\wamp64\www\tp5/application/admin\view\public\base.html";i:1527229214;s:56:"E:\wamp64\www\tp5/application/admin\view\public\nav.html";i:1501324619;s:58:"E:\wamp64\www\tp5/application/admin\view\public\aside.html";i:1535335564;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8" >
...
<link rel="stylesheet" type="text/css" href="__PUBLIC__/static/common/bootstrap/css/bootstrap.min.css" />
    ...
    <link rel="stylesheet" type="text/css" href="__PUBLIC__/static/common/font-awesome/css/font-awesome.min.css" />
    <link rel="stylesheet" type="text/css" href="__PUBLIC__/static/common/nprogress/nprogress.css" />
    <link rel="stylesheet" type="text/css" href="__PUBLIC__/static/common/iCheck/skins/flat/green.css" />
    <link rel="stylesheet" type="text/css" href="__PUBLIC__/static/common/datatables.net-bs/css/dataTables.bootstrap.min.css" />
    <link rel="stylesheet" type="text/css" href="__PUBLIC__/static/common/datatables.net-buttons-bs/css/buttons.bootstrap.min.css" />
    <link rel="stylesheet" type="text/css" href="__PUBLIC__/static/common/datatables.net-fixedheader-bs/css/fixedHeader.bootstrap.min.css" />
    <link rel="stylesheet" type="text/css" href="__PUBLIC__/static/common/datatables.net-responsive-bs/css/responsive.bootstrap.min.css" />
    <link rel="stylesheet" type="text/css" href="__PUBLIC__/static/common/datatables.net-scroller-bs/css/scroller.bootstrap.min.css" />
...
<body>
  ...
  <li>
	...
	<p class="welcome"><a href="<?php echo url('admin/index/index'); ?>"><span class="glyphicon glyphicon-home"></span> 首页</a> > <a href="<?php echo url('authrule/authrulelist'); ?>">规则管理</a> > 规则列表</p>
	<div>
		<ul class="list-inline">
			<li><a class="btn btn-success" href="<?php echo url('addauthrule'); ?>">新增规则</a></li>
		...
		<form action="" method="post" name="authrulelistform" id="authrulelistform" class="table-responsive">	    
			<table id="datatable-checkbox" class="table table-striped table-bordered bulk_action">
				...
				<tbody>
				<?php if(is_array($authrule) || $authrule instanceof \think\Collection || $authrule instanceof \think\Paginator): $i = 0; $__LIST__ = $authrule;if( count($__LIST__)==0 ) : echo "暂时没有数据！" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
					<tr>
						...
						<td><?php echo $vo['name']; ?></td> <!--可能调用无限极分类-->
						<td><?php echo !empty($vo['html'])?$vo['html']:' '; ?><?php echo $vo['title']; ?></td>
						<td><?php echo $vo['pid']; ?></td>
						<td><?php echo $vo['condition']; ?></td>
						<td><?php echo $vo['type']; ?></td>
						<td><?php if($vo['status'] == '1'): ?>正常<?php else: ?>禁用<?php endif; ?></td>
						<td>
							<a class="btn btn-primary" href="<?php echo url('addauthrule',['pid'=>$vo['id']]); ?>">添加</a>
							<a class="btn btn-info" href="<?php echo url('editorauthrule',['id'=>$vo['id']]); ?>">修改</a>
							<a class="btn btn-warning" href="<?php echo url('deleteauthrule',['id'=>$vo['id']]); ?>" onclick="return confirm('确定要删除该栏目吗？')">删除</a>						
						</td>
					</tr>
