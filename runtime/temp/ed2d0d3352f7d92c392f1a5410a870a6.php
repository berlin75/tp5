<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:55:"E:\wamp64\www\tp5/application/admin\view\log\index.html";i:1501741029;s:57:"E:\wamp64\www\tp5/application/admin\view\public\base.html";i:1527229214;s:56:"E:\wamp64\www\tp5/application/admin\view\public\nav.html";i:1501324619;s:58:"E:\wamp64\www\tp5/application/admin\view\public\aside.html";i:1535335564;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8" >
...
<body>
  ...
  <li>
	...
	<p class="welcome"><a href="<?php echo url('admin/index/index'); ?>"><span class="glyphicon glyphicon-home"></span> 首页</a> > <a href="<?php echo url('log/index'); ?>">登录日志</a> > 日志管理</p>
	<div class="wrap">
	登录日志列表：id,用户名，密码（*），状态(登录失败标红)，类型（前台后台登录），时间，ip，地址，说明（登录错误或成功提示）
	</div>
